      ...
      <main className="flex-grow px-6 py-16">
        <div className="max-w-md mx-auto">
          <div className="bg-white p-10 rounded-2xl shadow-lg border border-outline-variant/20 animate-fade-in">
            ...
            <p className="text-center text-on-surface-variant mb-8">{tA.subtitle || 'Accédez à votre compte TAOMAN GROUP INVESTMENTS'}</p>
      ...
      <main className="flex-grow px-6 py-16">
        <div className="max-w-md mx-auto">
          <div className="bg-white p-10 rounded-2xl shadow-lg border border-outline-variant/20 animate-fade-in">
            ...
            <p className="text-center text-on-surface-variant mb-8">{tR.subtitle || 'Créez votre compte TAOMAN GROUP INVESTMENTS'}</p>
