        ...
        <section className="bg-gradient-to-br from-primary to-primary-container py-16 px-6">
          <div className="max-w-[1100px] mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-3">
              ...
              <Link to="/contact" className="rounded-2xl border border-white text-white px-8 py-4 font-bold hover:bg-white hover:text-primary transition inline-flex justify-center items-center">
