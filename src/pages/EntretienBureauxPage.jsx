  ...
  return (
    <div className="flex flex-col min-h-screen bg-surface">
      <SeoHead
        ...
        keywords="entretien bureaux Lomé, nettoyage professionnel Togo, contrat entretien, TAOMAN GROUP INVESTMENTS"
      />
          ...
          <div className="max-w-[1000px] mx-auto">
            ...
            <div className="space-y-4">
              {[
                ...
                { q: "Qui fournit les produits et le matériel ?", a: "Par défaut, TAOMAN GROUP INVESTMENTS fournit tous les produits et tout le matériel professionnel. Le coût est inclus dans le forfait. Si vous préférez fournir vos propres produits, nous pouvons l'organiser et déduire la part correspondante." },
        ...
        <section className="bg-gradient-to-br from-primary to-primary-container py-16 px-6">
          <div className="max-w-[1100px] mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-3">
              <Link to="/contact" className="rounded-2xl bg-white text-primary px-8 py-4 font-bold hover:opacity-90 transition">
                Demander une visite
              </Link>
              <Link to="/services" className="rounded-2xl border border-white text-white px-8 py-4 font-bold hover:bg-white hover:text-primary transition inline-flex justify-center items-center">
