        ...
        <section className="relative overflow-hidden bg-[#07111f] pt-12 pb-20 text-white md:pt-20 md:pb-32">
          ...
          <div className="relative z-10 max-w-[1400px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-[1.05fr_0.95fr] gap-12 items-center">
            <div className="animate-fade-in-up">
              ...
              <h1 className="mb-6 leading-tight tracking-[-0.05em]">
                <span className="block text-4xl md:text-6xl font-black text-cyan-200">{heroData.title}</span>
                <span className="mt-2 block text-xl md:text-3xl font-bold text-white">{heroData.subtitle}</span>
              </h1>
