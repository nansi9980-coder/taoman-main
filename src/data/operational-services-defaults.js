...
export const OPERATIONAL_SERVICE_TEMPLATES = [
  {
    ...
    description:
      'Nettoyage intérieur et extérieur premium, vitres, jantes, pneus, polissage carrosserie. En centre TAOMAN GROUP INVESTMENTS ou en mobile à domicile.',
    badge: 'Populaire',
    sla: '45 – 90 min',
  ...
  },
  {
    ...
    priceFrom: 'Sur devis',
    bullets: ['Équipe identifiée en uniforme TAOMAN GROUP INVESTMENTS', 'Produits écologiques et matériel professionnel', 'Reporting mensuel et contrôle qualité'],
