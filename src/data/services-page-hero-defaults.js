export const SERVICES_PAGE_HERO_SLIDES = [
  ...
  { id: 'demenagement', title: 'Camion de déménagement Taoman Group Investissement', category: 'Déménagement', imageUrl: '' },
  { id: 'transport', title: 'Conducteur Taoman Group Investissement sur le terrain', category: 'Transport', imageUrl: '' },
  { id: 'mecanique', title: 'Atelier mécanique multimarques', category: 'Mécanique', imageUrl: '' },
  { id: 'equipe', title: 'Équipe terrain Taoman Group Investissement', category: 'Équipe', imageUrl: '' },
];
