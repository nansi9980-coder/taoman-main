import { BRAND_NAME } from '../constants/branding';
  ...
  export const HOME_SERVICE_FALLBACKS = {
    FR: {
      services: [
      ...
      labels: ['Conducteur TAOMAN GROUP INVESTMENTS', 'Équipe de transport', 'Centre de lavage', 'Intervention terrain', 'Flotte opérationnelle', 'Commerce agro']
    },
    EN: {
      services: [
      ...
      labels: ['TAOMAN GROUP INVESTMENTS Driver', 'Transport Team', 'Wash Center', 'Field Intervention', 'Operational Fleet', 'Agro Trade']
    },
    ES: {
      services: [
      ...
      labels: ['Conductor TAOMAN GROUP INVESTMENTS', 'Equipo de Transporte', 'Centro de Lavado', 'Intervención en Terreno', 'Flota Operativa', 'Comercio Agro']
    },
    PT: {
      services: [
      ...
      labels: ['Motorista TAOMAN GROUP INVESTMENTS', 'Equipe de Transporte', 'Centro de Lavagem', 'Intervenção em Campo', 'Frota Operacional', 'Comércio Agro']
    },
    DE: {
      services: [
      ...
      labels: ['TAOMAN GROUP INVESTMENTS Fahrer', 'Transportteam', 'Waschzentrum', 'Außendienst', 'Flotte', 'Agrarhandel']
    },
    AR: {
      services: [
      ...
      labels: ['سائق TAOMAN GROUP INVESTMENTS', 'فريق النقل', 'مركز غسيل', 'التدخل الميداني', 'أسطول العمليات', 'التجارة الزراعية']
    },
    ZH: {
      services: [
      ...
      labels: ['TAOMAN GROUP INVESTMENTS 司机', '运输团队', '洗车中心', '现场干预', '运营车队', '农业贸易']
    }
  };
