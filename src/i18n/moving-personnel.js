...
const FR = {
  ...
  commitments: [
    ...
    { title: 'Équipe identifiée', desc: 'Déménageurs en uniforme Taoman Group Investissement et identifiables.' },
  ...
  labels: {
    ...
    vehiclesIntro: 'Trois formats pour votre volume, distance et budget. Véhicules entretenus dans notre atelier Taoman Group Investissement.',
...
const EN = {
  ...
  commitments: [
    ...
    { title: 'Identified team', desc: 'Taoman Group Investissement uniformed, identifiable movers.' },
  ...
  labels: {
    ...
    vehiclesIntro: 'Three formats for volume, distance and budget. Vehicles maintained in our Taoman Group Investissement workshop.',
