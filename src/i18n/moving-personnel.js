...
const FR = {
  ...
  commitments: [
    ...
    { title: 'Équipe identifiée', desc: 'Déménageurs en uniforme TAOMAN GROUP INVESTMENTS et identifiables.' },
  ...
  labels: {
    ...
    vehiclesIntro: 'Trois formats pour votre volume, distance et budget. Véhicules entretenus dans notre atelier TAOMAN GROUP INVESTMENTS.',
...
const EN = {
  ...
  commitments: [
    ...
    { title: 'Identified team', desc: 'TAOMAN GROUP INVESTMENTS uniformed, identifiable movers.' },
  ...
  labels: {
    ...
    vehiclesIntro: 'Three formats for volume, distance and budget. Vehicles maintained in our TAOMAN GROUP INVESTMENTS workshop.',
