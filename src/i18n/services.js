...
const FR_ITEMS = makeItems([
  ...
  },
  {
    ...
    description:
      'Atelier multimarques TAOMAN GROUP INVESTMENTS : entretien préventif, vidange, freins, suspension, embrayage, climatisation auto, diagnostic électronique OBD. Contrats flotte avec carnet de suivi par véhicule.',
    sla: 'Devis 24h',
    badge: 'Atelier pro',
    bullets: [
...
const EN_ITEMS = makeItems([
  ...
  },
  {
    ...
    description:
      'TAOMAN GROUP INVESTMENTS multi-brand workshop: preventive maintenance, oil change, brakes, suspension, clutch, auto A/C, OBD electronic diagnostics. Fleet contracts with per-vehicle service log.',
...
const PT_ITEMS = makeItems([
  ...
  { id: 'mecanique', title: 'Mecânica automóvel', description: 'Oficina multimarca TAOMAN GROUP INVESTMENTS: manutenção preventiva, mudança de óleo, travões, suspensão, embraiagem, climatização auto, diagnóstico eletrónico OBD. Contratos de frota com registo por veículo.', sla: 'Orçamento 24h', badge: 'Oficina pro', bullets: ['Diagnóstico eletrónico multimarca', 'Peças novas ou recondicionadas', 'Acompanhamento de frota com registo digital'], priceFrom: 'Orçamento transparente' },
...
const AR_ITEMS = makeItems([
  ...
  { id: 'mecanique', title: 'ميكانيكا السيارات', description: 'ورشة TAOMAN GROUP INVESTMENTS متعددة العلامات: صيانة وقائية، تغيير زيت، فرامل، تعليق، قابض، تكييف السيارات، تشخيص OBD. عقود أساطيل مع سجل صيانة لكل مركبة.', sla: 'عرض خلال 24 ساعة', badge: 'ورشة احترافية', bullets: ['تشخيص إلكتروني متعدد العلامات', 'قطع جديدة أو مجددة', 'متابعة الأسطول بسجل رقمي'], priceFrom: 'عرض شفاف' },
...
const ZH_ITEMS = makeItems([
  ...
  { id: 'mecanique', title: '汽车维修', description: 'TAOMAN GROUP INVESTMENTS 多品牌车间：预防性保养、换油、制动、悬挂、离合器、汽车空调、OBD 电子诊断。车队合同含每车维保记录。', sla: '24 小时报价', badge: '专业车间', bullets: ['多品牌电子诊断', '全新或翻新配件', '车队数字维保记录跟踪'], priceFrom: '透明报价' },
