...
const FR_ITEMS = makeItems([
  {
    ...
    description:
      'Nettoyage intérieur et extérieur premium, vitres, jantes, pneus, polissage carrosserie. En centre Taoman Group Investissement ou en mobile à domicile pour les particuliers, et contrats flotte multi-véhicules pour les entreprises et institutions.',
    sla: '45 – 90 min',
    badge: 'Populaire',
    bullets: [
  ...
  },
  {
    ...
    badge: 'Contrat pro',
    bullets: [
      'Équipe identifiée en uniforme Taoman Group Investissement',
  ...
  },
  {
    ...
    description:
      'Atelier multimarques Taoman Group Investissement : entretien préventif, vidange, freins, suspension, embrayage, climatisation auto, diagnostic électronique OBD. Contrats flotte avec carnet de suivi par véhicule.',
    sla: 'Devis 24h',
    badge: 'Atelier pro',
    bullets: [
...
const FR_DETAILED_ITEMS = [
  {
    ...
    title: 'Lavage automobile & moto',
    intro:
      'Notre centre de lavage Taoman Group Investissement combine équipements professionnels, produits adaptés à chaque type de carrosserie et personnel formé.',
    points: [
  ...
  },
  {
    ...
    points: [
      ...
      'Équipes en uniforme Taoman Group Investissement, identifiables, et superviseur dédié joignable 24/7.',
  ...
  },
  {
    ...
    title: 'Mécanique automobile',
    intro:
      'Notre atelier multimarques traite véhicules thermiques et hybrides avec outils de diagnostic récents et techniciens certifiés.',
    points: [
  ...
  },
  {
    ...
    title: 'Audits & Reporting',
    intro:
      "Taoman Group Investissement met son expertise opérationnelle et financière au service des PME, investisseurs et institutions togolaises qui ont besoin de transparence et de structuration. Nos audits débouchent sur des plans d'action concrets et nos rapports sont conformes aux standards SYSCOA et CEDEAO.",
    points: [
...
const FR = {
  ...
  detailed: {
    ...
    description:
      'Au-delà du devis, nous croyons à la transparence : voici comment nous travaillons, ce que nous incluons, et pourquoi nos clients renouvellent leurs contrats avec Taoman Group Investissement.',
...
const EN_ITEMS = makeItems([
  {
    ...
    description:
      'Premium interior and exterior cleaning, windows, rims, tyres, body polishing. At Taoman Group Investissement centre or mobile at home for individuals, and multi-vehicle fleet contracts for businesses and institutions.',
    sla: '45 – 90 min',
    badge: 'Popular',
    bullets: [
  ...
  },
  {
    ...
    badge: 'Pro contract',
    bullets: [
      'Identified team in Taoman Group Investissement uniform',
  ...
  },
  {
    ...
    description:
      'Taoman Group Investissement multi-brand workshop: preventive maintenance, oil change, brakes, suspension, clutch, auto A/C, OBD electronic diagnostics. Fleet contracts with per-vehicle service log.',
    sla: 'Quote within 24h',
    badge: 'Pro workshop',
    bullets: [
      'Multi-brand electronic diagnostics',
      'New or reconditioned parts',
      'Fleet tracking with digital service log',
    ],
    priceFrom: 'Transparent quote',
  },
  {
    id: 'transport',
...
const EN_DETAILED_ITEMS = [
  {
    ...
    title: 'Car & motorcycle wash',
    intro:
      'Our Taoman Group Investissement wash centre combines professional equipment, products suited to each body type and trained staff.',
    points: [
  ...
  },
  {
    ...
    points: [
      ...
      'Teams in identifiable Taoman Group Investissement uniforms and dedicated supervisor reachable 24/7.',
  ...
  },
  {
    ...
    title: 'Automotive mechanics',
    intro:
      'Our multi-brand workshop handles combustion and hybrid vehicles with up-to-date diagnostic tools and certified technicians.',
    points: [
      'Preventive maintenance: oil change, filters, belt, brakes, suspension, A/C, timing.',
      'OBD electronic diagnostics for complex faults (engine, ABS, ESP, airbag).',
      'Transparent quote before work, new or reconditioned parts at your choice.',
      'Fleet contracts with digital service log per vehicle and automatic reminders.',
    ],
  },
  {
    id: 'transport',
  ...
  },
  {
    ...
    title: 'Audits & Reporting',
    intro:
      'Taoman Group Investissement brings operational and financial expertise to Togolese SMEs, investors and institutions that need transparency and structure. Our audits lead to concrete action plans and reports aligned with SYSCOA and ECOWAS standards.',
    points: [
...
const EN = {
  ...
  detailed: {
    ...
    description:
      'Beyond the quote, we believe in transparency: here is how we work, what we include, and why our clients renew their contracts with Taoman Group Investissement.',
  ...
  whyUs: {
    eyebrow: 'Why Taoman Group Investissement',
...
const ES_ITEMS = makeItems([
  { id: 'lavage', title: 'Lavado de coches y motos', description: 'Limpieza premium interior y exterior, cristales, llantas, neumáticos, pulido de carrocería. En centro Taoman Group Investissement o a domicilio para particulares, y contratos de flota para empresas e instituciones.', sla: '45 – 90 min', badge: 'Popular', bullets: ['Lavado exterior + interior completo', 'Pulido, abrillantado y protección de carrocería', 'Contratos de flota con planificación semanal'], priceFrom: 'Desde 3 500 FCFA' },
  ...
  { id: 'entretien-bureaux', title: 'Limpieza de oficinas', description: 'Limpieza profesional regular de oficinas, comercios, clínicas y escuelas. Contratos diarios, semanales o mensuales con informes fotográficos, control de calidad en terreno y supervisor dedicado.', sla: 'Diario / semanal', badge: 'Contrato pro', bullets: ['Equipo identificado con uniforme Taoman Group Investissement', 'Productos ecológicos y material profesional', 'Informe mensual y control de calidad'], priceFrom: 'Bajo presupuesto' },
  { id: 'mecanique', title: 'Mecánica automotriz', description: 'Taller multimarca Taoman Group Investissement: mantenimiento preventivo, cambio de aceite, frenos, suspensión, embrague, climatización auto, diagnóstico electrónico OBD. Contratos de flota con historial por vehículo.', sla: 'Presupuesto 24h', badge: 'Taller pro', bullets: ['Diagnóstico electrónico multimarca', 'Piezas nuevas o reacondicionadas', 'Seguimiento de flota con historial digital'], priceFrom: 'Presupuesto transparente' },
...
const ES_DETAILED_ITEMS = [
  ...
  { id: 'entretien-bureaux', title: 'Limpieza de oficinas', intro: 'Un entorno de trabajo limpio impulsa la productividad. Nuestros contratos se integran sin perturbar su actividad.', points: ['Paso diario (antes de apertura), semanal o quincenal según necesidad.', 'Prestaciones: suelos, superficies, sanitarios, cristales, papeleras, desinfección de puntos de contacto.', 'Equipos con uniforme Taoman Group Investissement identificable y supervisor dedicado 24/7.', 'Informe mensual con fotos antes/después, seguimiento de calidad y plan trimestral de mejora.'] },
  { id: 'mecanique', title: 'Mecánica automotriz', intro: 'Nuestro taller multimarca trata vehículos térmicos e híbridos con herramientas de diagnóstico recientes y técnicos certificados.', points: ['Mantenimiento preventivo: aceite, filtros, correa, frenos, suspensión, climatización, distribución.', 'Diagnóstico OBD para averías complejas (motor, ABS, ESP, airbag).', 'Presupuesto transparente antes de intervenir, piezas nuevas o reacondicionadas a elegir.', 'Contratos de flota con historial digital por vehículo y recordatorios automáticos.'] },
...
const ES = {
  ...
  detailed: { eyebrow: 'Más allá del presupuesto', description: 'Más allá del presupuesto, creemos en la transparencia: así trabajamos, qué incluimos y por qué nuestros clientes renuevan sus contratos con Taoman Group Investissement.', items: ES_DETAILED_ITEMS },
  ...
  whyUs: { eyebrow: 'Por qué Taoman Group Investissement', title: 'Tres compromisos simples', description: 'Disponibilidad, profesionalismo y seguimiento: nuestros tres pilares de calidad.', items: [{ title: 'Disponibilidad', desc: 'Servicio día y noche, 7 días a la semana, soporte WhatsApp y teléfono.' }, { title: 'Profesional', desc: 'Equipo formado e identificado, equipos adaptados, procedimientos de calidad claros.' }, { title: 'Seguimiento cliente', desc: 'Control tras la intervención, fotos documentadas y feedback integrado al plan de mejora.' }] },
...
const PT_ITEMS = makeItems([
  { id: 'lavage', title: 'Lavagem automóvel e moto', description: 'Limpeza premium interior e exterior, vidros, jantes, pneus, polimento de carroçaria. No centro Taoman Group Investissement ou ao domicílio para particulares, e contratos de frota para empresas e instituições.', sla: '45 – 90 min', badge: 'Popular', bullets: ['Lavagem exterior + interior completa', 'Polimento, brilho e proteção da carroçaria', 'Contratos de frota com planeamento semanal'], priceFrom: 'A partir de 3 500 FCFA' },
  ...
  { id: 'entretien-bureaux', title: 'Limpeza de escritórios', description: 'Limpeza profissional regular de escritórios, comércios, clínicas e escolas. Contratos diários, semanais ou mensais com reporting fotográfico, controlo de qualidade em terreno e supervisor dedicado.', sla: 'Diário / semanal', badge: 'Contrato pro', bullets: ['Equipa identificada com uniforme Taoman Group Investissement', 'Produtos ecológicos e material profissional', 'Reporting mensal e controlo de qualidade'], priceFrom: 'Sob orçamento' },
  { id: 'mecanique', title: 'Mecânica automóvel', description: 'Oficina multimarca Taoman Group Investissement: manutenção preventiva, mudança de óleo, travões, suspensão, embraiagem, climatização auto, diagnóstico eletrónico OBD. Contratos de frota com registo por veículo.', sla: 'Orçamento 24h', badge: 'Oficina pro', bullets: ['Diagnóstico eletrónico multimarca', 'Peças novas ou recondicionadas', 'Acompanhamento de frota com registo digital'], priceFrom: 'Orçamento transparente' },
...
const PT_DETAILED_ITEMS = [
  ...
  { id: 'entretien-bureaux', title: 'Limpeza de escritórios', intro: 'Um ambiente de trabalho limpo aumenta a produtividade. Os nossos contratos integram-se sem perturbar a sua atividade.', points: ['Passagem diária (antes da abertura), semanal ou quinzenal conforme necessidade.', 'Prestações: chãos, superfícies, sanitários, vidros, caixotes do lixo, desinfeção de pontos de contacto.', 'Equipas com uniforme Taoman Group Investissement identificável e supervisor dedicado 24/7.', 'Reporting mensal com fotos antes/depois, acompanhamento de qualidade e plano trimestral de melhoria.'] },
  { id: 'mecanique', title: 'Mecânica automóvel', intro: 'A nossa oficina multimarca trata veículos térmicos e híbridos com ferramentas de diagnóstico recentes e técnicos certificados.', points: ['Manutenção preventiva: óleo, filtros, correia, travões, suspensão, climatização, distribuição.', 'Diagnóstico OBD para avarias complexas (motor, ABS, ESP, airbag).', 'Orçamento transparente antes da intervenção, peças novas ou recondicionadas à escolha.', 'Contratos de frota com registo digital por veículo e lembretes automáticos.'] },
...
const PT = {
  ...
  detailed: { eyebrow: 'Para além do orçamento', description: 'Para além do orçamento, acreditamos na transparência: eis como trabalhamos, o que incluímos e por que os nossos clientes renovam os contratos com a Taoman Group Investissement.', items: PT_DETAILED_ITEMS },
...
const DE_ITEMS = makeItems([
  { id: 'lavage', title: 'Auto- & Motorradwäsche', description: 'Premium-Innen- und Außenreinigung, Scheiben, Felgen, Reifen, Lackpolitur. Im Taoman Group Investissement-Zentrum oder mobil zu Hause für Privatkunden, Flottenverträge für Unternehmen und Institutionen.', sla: '45 – 90 Min.', badge: 'Beliebt', bullets: ['Vollständige Außen- und Innenreinigung', 'Polieren, Glanz und Lackschutz', 'Flottenverträge mit wöchentlicher Planung'], priceFrom: 'Ab 3.500 FCFA' },
  ...
  { id: 'entretien-bureaux', title: 'Büroreinigung', description: 'Regelmäßige professionelle Reinigung von Büros, Geschäften, Kliniken und Schulen. Tägliche, wöchentliche oder monatliche Verträge mit Fotoreporting, Qualitätskontrolle vor Ort und dediziertem Supervisor.', sla: 'Täglich / wöchentlich', badge: 'Pro-Vertrag', bullets: ['Identifiziertes Team in Taoman Group Investissement-Uniform', 'Umweltfreundliche Produkte und Profi-Ausrüstung', 'Monatliches Reporting und Qualitätskontrolle'], priceFrom: 'Auf Anfrage' },
  { id: 'mecanique', title: 'Kfz-Mechanik', description: 'Taoman Group Investissement-Mehrmarken-Werkstatt: vorbeugende Wartung, Ölwechsel, Bremsen, Federung, Kupplung, Klimaanlage, OBD-Diagnose. Flottenverträge mit Serviceheft pro Fahrzeug.', sla: 'Angebot 24h', badge: 'Pro-Werkstatt', bullets: ['Elektronische Mehrmarken-Diagnose', 'Neue oder generalüberholte Teile', 'Flottenbetreuung mit digitalem Serviceheft'], priceFrom: 'Transparentes Angebot' },
...
const DE_DETAILED_ITEMS = [
  ...
  { id: 'entretien-bureaux', title: 'Büroreinigung', intro: 'Eine saubere Arbeitsumgebung steigert die Produktivität. Unsere Verträge integrieren sich ohne Störung Ihres Betriebs.', points: ['Täglicher (vor Öffnung), wöchentlicher oder zweiwöchentlicher Einsatz nach Bedarf.', 'Leistungen: Böden, Oberflächen, Sanitäranlagen, Fenster, Abfalleimer, Kontaktflächendesinfektion.', 'Teams in erkennbarer Taoman Group Investissement-Uniform und dedizierter Supervisor 24/7 erreichbar.', 'Monatliches Reporting mit Vorher/Nachher-Fotos, Qualitätsverfolgung und vierteljährlichem Verbesserungsplan.'] },
  { id: 'mecanique', title: 'Kfz-Mechanik', intro: 'Unsere Mehrmarken-Werkstatt betreut Verbrenner und Hybride mit aktuellen Diagnosegeräten und zertifizierten Technikern.', points: ['Vorbeugende Wartung: Öl, Filter, Riemen, Bremsen, Federung, Klima, Steuerkette.', 'OBD-Diagnose für komplexe Fehler (Motor, ABS, ESP, Airbag).', 'Transparentes Angebot vor Eingriff, neue oder generalüberholte Teile nach Wahl.', 'Flottenverträge mit digitalem Serviceheft pro Fahrzeug und automatischen Erinnerungen.'] },
...
const DE = {
  ...
  detailed: { eyebrow: 'Über das Angebot hinaus', description: 'Über das Angebot hinaus setzen wir auf Transparenz: So arbeiten wir, was wir einschließen und warum unsere Kunden ihre Verträge mit Taoman Group Investissement verlängern.', items: DE_DETAILED_ITEMS },
  ...
  whyUs: { eyebrow: 'Warum Taoman Group Investissement', title: 'Drei einfache Verpflichtungen', description: 'Verfügbarkeit, Professionalität und Nachverfolgung: unsere drei Qualitätssäulen.', items: [{ title: 'Verfügbarkeit', desc: 'Service Tag und Nacht, 7 Tage die Woche, WhatsApp- und Telefon-Support.' }, { title: 'Professionell', desc: 'Geschultes, identifizierbares Team, passende Ausrüstung, klare Qualitätsverfahren.' }, { title: 'Kundenbetreuung', desc: 'Kontrolle nach dem Eingriff, dokumentierte Fotos und Feedback im Verbesserungsplan.' }] },
...
const AR_ITEMS = makeItems([
  ...
  { id: 'entretien-bureaux', title: 'تنظيف المكاتب', description: 'تنظيف مهني منتظم للمكاتب والمحلات والعيادات والمدارس. عقود يومية أو أسبوعية أو شهرية مع تقارير مصورة ومراقبة جودة ميدانية ومشرف مخصص.', sla: 'يومي / أسبوعي', badge: 'عقد احترافي', bullets: ['فريق معرّف بزي Taoman Group Investissement', 'منتجات صديقة للبيئة ومعدات مهنية', 'تقرير شهري ومراقبة جودة'], priceFrom: 'حسب العرض' },
  { id: 'mecanique', title: 'ميكانيكا السيارات', description: 'ورشة Taoman Group Investissement متعددة العلامات: صيانة وقائية، تغيير زيت، فرامل، تعليق، قابض، تكييف السيارات، تشخيص OBD. عقود أساطيل مع سجل صيانة لكل مركبة.', sla: 'عرض خلال 24 ساعة', badge: 'ورشة احترافية', bullets: ['تشخيص إلكتروني متعدد العلامات', 'قطع جديدة أو مجددة', 'متابعة الأسطول بسجل رقمي'], priceFrom: 'عرض شفاف' },
...
const AR_DETAILED_ITEMS = [
  ...
  { id: 'entretien-bureaux', title: 'تنظيف المكاتب', intro: 'بيئة عمل نظيفة تعزز الإنتاجية. عقودنا مصممة للاندماج دون تعطيل نشاطكم.', points: ['زيارة يومية (قبل الافتتاح) أو أسبوعية أو كل أسبوعين حسب الحاجة.', 'خدمات: أرضيات، أسطح، دورات مياه، زجاج، إفراغ سلال، تعقيم نقاط اللمس.', 'فرق بزي Taoman Group Investissement معرّف ومشرف مخصص متاح 24/7.', 'تقرير شهري بصور قبل/بعد، متابعة جودة وخطة تحسين ربع سنوية.'] },
  { id: 'mecanique', title: 'ميكانيكا السيارات', intro: 'تعالج ورشتنا متعددة العلامات المركبات الحرارية والهجينة بأدوات تشخيص حديثة وفنيين معتمدين.', points: ['صيانة وقائية: زيت، فلاتر، سير، فرامل، تعليق، تكييف، توقيت.', 'تشخيص OBD للأعطال المعقدة (محرك، ABS، ESP، وسادة هوائية).', 'عرض شفاف قبل التدخل، قطع جديدة أو مجددة حسب الاختيار.', 'عقود أساطيل بسجل رقمي لكل مركبة وتذكيرات تلقائية.'] },
...
const AR = {
  ...
  detailed: { eyebrow: 'ما بعد عرض السعر', description: 'ما بعد عرض السعر، نؤمن بالشفافية: هكذا نعمل، ما نقدمه، ولماذا يجدد عملاؤنا عقودهم مع Taoman Group Investissement.', items: AR_DETAILED_ITEMS },
...
const ZH_ITEMS = makeItems([
  { id: 'lavage', title: '汽车与摩托车清洗', description: '优质内外清洁、玻璃、轮毂、轮胎、车身抛光。Taoman Group Investissement 中心或上门移动服务面向个人，企业及机构多车车队合同。', sla: '45 – 90 分钟', badge: '热门', bullets: ['全面外部+内部清洗', '抛光、上光与车身保护', '车队合同含每周排程'], priceFrom: '起价 3 500 FCFA' },
  ...
  { id: 'entretien-bureaux', title: '办公室保洁', description: '办公室、商铺、诊所及学校定期专业清洁。日/周/月合同，含照片报告、现场质量管控及专属督导。', sla: '每日/每周', badge: '专业合同', bullets: ['着 Taoman Group Investissement 制服的可识别团队', '环保产品与专业设备', '月度报告与质量检查'], priceFrom: '询价' },
  { id: 'mecanique', title: '汽车维修', description: 'Taoman Group Investissement 多品牌车间：预防性保养、换油、制动、悬挂、离合器、汽车空调、OBD 电子诊断。车队合同含每车维保记录。', sla: '24 小时报价', badge: '专业车间', bullets: ['多品牌电子诊断', '全新或翻新配件', '车队数字维保记录跟踪'], priceFrom: '透明报价' },
...
const ZH_DETAILED_ITEMS = [
  { id: 'lavage', title: '汽车与摩托车清洗', intro: 'Taoman Group Investissement 洗车中心配备专业设备、适配各车身类型的产品及培训人员。', points: ['三种套餐：快捷（15 分钟）、高级（45 分钟内外）、全套（90 分钟含抛光与保护）。', '预约上门移动服务，团队自带水与设备。', '企业月度车队合同：递减价格、固定排程、照片报告。', '认证可降解产品与循环用水——真正的环保实践。'] },
  ...
  { id: 'entretien-bureaux', title: '办公室保洁', intro: '洁净工作环境提升生产力。我们的合同设计为不打断您的日常运营。', points: ['每日（开业前）、每周或每两周上门，按需定制。', '服务含：地面、台面、卫生间、玻璃、倒垃圾、接触点消毒。', '着可识别 Taoman Group Investissement 制服团队，专属督导 24/7 可联系。', '月度报告含前后照片、质量跟踪及季度改进计划。'] },
  { id: 'mecanique', title: '汽车维修', intro: '多品牌车间以最新诊断设备及认证技师处理燃油与混合动力车辆。', points: ['预防保养：换油、滤芯、皮带、制动、悬挂、空调、正时。', 'OBD 电子诊断处理复杂故障（发动机、ABS、ESP、气囊）。', '施工前透明报价，全新或翻新配件可选。', '车队合同含每车数字维保记录与自动提醒。'] },
  ...
  { id: 'audits', title: '审计与报告', intro: 'Taoman Group Investissement 将运营与财务专长服务于需要透明与结构化的多哥中小企业、投资者及机构。审计产出具体行动计划，报告符合 SYSCOA 与 CEDEAO。', points: ['全面财务审计：账目分析、现金流、隐性风险及 90 天整改建议。', '运营审计：流程审查、现场质量、人力、内部合规及风险图谱。', '投资者报告：月度仪表盘、季度 PDF、KPI、偏差预警及年度合并报告。', 'KYC 合规：身份核验、反洗钱、SYSCOA、CEDEAO 及机构投资者材料准备。', '治理支持：董事会筹备、纪要、审计委员会及高管财务阅读培训。', '数字工具：安全门户下载报告、实时 KPI 及临界阈值 WhatsApp 通知。'] },
];

const ZH = {
  items: ZH_ITEMS,
  labels: { timeLabel: '工期', priceLabel: '价格', priceFromFallback: '询价', requestQuoteCta: '索取报价', badgeAvailable: '可预约', badgeSoon: '即将推出' },
  detailed: { eyebrow: '超越报价', description: '超越报价，我们坚持透明：我们的工作方式、包含内容，以及客户为何与 Taoman Group Investissement 续约。', items: ZH_DETAILED_ITEMS },
  ...
  whyUs: { eyebrow: '为何选择 Taoman Group Investissement', title: '三项简单承诺', description: '可用性、专业性与跟进：我们的三大质量支柱。', items: [{ title: '可用性', desc: '日夜服务，每周 7 天，WhatsApp 与电话支持。' }, { title: '专业', desc: '培训可识别团队、适配设备、清晰质量流程。' }, { title: '客户跟进', desc: '服务后检查、存档照片及反馈纳入改进计划。' }] },
