...
const FR_DETAILED_ITEMS = [
  {
    ...
    title: 'Lavage automobile & moto',
    intro:
      'Notre centre de lavage TAOMAN combine équipements professionnels, produits adaptés à chaque type de carrosserie et personnel formé.',
    points: [
  ...
  },
  {
    ...
    title: 'Audits & Reporting',
    intro:
      "TAOMAN met son expertise opérationnelle et financière au service des PME, investisseurs et institutions togolaises qui ont besoin de transparence et de structuration. Nos audits débouchent sur des plans d'action concrets et nos rapports sont conformes aux standards SYSCOA et CEDEAO.",
    points: [
...
const FR = {
  ...
  detailed: {
    ...
    description:
      'Au-delà du devis, nous croyons à la transparence : voici comment nous travaillons, ce que nous incluons, et pourquoi nos clients renouvellent leurs contrats avec TAOMAN Group Investment.',
...
const EN_ITEMS = makeItems([
  {
    ...
    description:
      'Premium interior and exterior cleaning, windows, rims, tyres, body polishing. At TAOMAN centre or mobile at home for individuals, and multi-vehicle fleet contracts for businesses and institutions.',
    sla: '45 – 90 min',
    badge: 'Popular',
    bullets: [
  ...
  },
  {
    ...
    badge: 'Pro contract',
    bullets: [
      'Identified team in TAOMAN uniform',
  ...
  },
  {
    ...
    description:
      'TAOMAN multi-brand workshop: preventive maintenance, oil change, brakes, suspension, clutch, auto A/C, OBD electronic diagnostics. Fleet contracts with per-vehicle service log.',
...
const EN_DETAILED_ITEMS = [
  {
    ...
    title: 'Car & motorcycle wash',
    intro:
      'Our TAOMAN wash centre combines professional equipment, products suited to each body type and trained staff.',
    points: [
  ...
  },
  {
    ...
    points: [
      ...
      'Teams in identifiable TAOMAN uniforms and dedicated supervisor reachable 24/7.',
  ...
  },
  {
    ...
    title: 'Audits & Reporting',
    intro:
      'TAOMAN brings operational and financial expertise to Togolese SMEs, investors and institutions that need transparency and structure. Our audits lead to concrete action plans and reports aligned with SYSCOA and ECOWAS standards.',
    points: [
...
const EN = {
  ...
  detailed: {
    ...
    description:
      'Beyond the quote, we believe in transparency: here is how we work, what we include, and why our clients renew their contracts with TAOMAN Group Investment.',
...
const ES_ITEMS = makeItems([
  { id: 'lavage', title: 'Lavado de coches y motos', description: 'Limpieza premium interior y exterior, cristales, llantas, neumáticos, pulido de carrocería. En centro TAOMAN o a domicilio para particulares, y contratos de flota para empresas e instituciones.', sla: '45 – 90 min', badge: 'Popular', bullets: ['Lavado exterior + interior completo', 'Pulido, abrillantado y protección de carrocería', 'Contratos de flota con planificación semanal'], priceFrom: 'Desde 3 500 FCFA' },
...
const ES = {
  ...
  detailed: { eyebrow: 'Más allá del presupuesto', description: 'Más allá del presupuesto, creemos en la transparencia: así trabajamos, qué incluimos y por qué nuestros clientes renuevan sus contratos con TAOMAN Group Investment.', items: ES_DETAILED_ITEMS },
...
const PT_ITEMS = makeItems([
  { id: 'lavage', title: 'Lavagem automóvel e moto', description: 'Limpeza premium interior e exterior, vidros, jantes, pneus, polimento de carroçaria. No centro TAOMAN ou ao domicílio para particulares, e contratos de frota para empresas e instituições.', sla: '45 – 90 min', badge: 'Popular', bullets: ['Lavagem exterior + interior completa', 'Polimento, brilho e proteção da carroçaria', 'Contratos de frota com planeamento semanal'], priceFrom: 'A partir de 3 500 FCFA' },
...
const PT = {
  ...
  detailed: { eyebrow: 'Para além do orçamento', description: 'Para além do orçamento, acreditamos na transparência: eis como trabalhamos, o que incluímos e por que os nossos clientes renovam os contratos com a TAOMAN Group Investment.', items: PT_DETAILED_ITEMS },
...
const DE_ITEMS = makeItems([
  { id: 'lavage', title: 'Auto- & Motorradwäsche', description: 'Premium-Innen- und Außenreinigung, Scheiben, Felgen, Reifen, Lackpolitur. Im TAOMAN-Zentrum oder mobil zu Hause für Privatkunden, Flottenverträge für Unternehmen und Institutionen.', sla: '45 – 90 Min.', badge: 'Beliebt', bullets: ['Vollständige Außen- und Innenreinigung', 'Polieren, Glanz und Lackschutz', 'Flottenverträge mit wöchentlicher Planung'], priceFrom: 'Ab 3.500 FCFA' },
...
const DE = {
  ...
  detailed: { eyebrow: 'Über das Angebot hinaus', description: 'Über das Angebot hinaus setzen wir auf Transparenz: So arbeiten wir, was wir einschließen und warum unsere Kunden ihre Verträge mit TAOMAN Group Investment verlängern.', items: DE_DETAILED_ITEMS },
  ...
  whyUs: { eyebrow: 'Warum TAOMAN', title: 'Drei einfache Verpflichtungen', description: 'Verfügbarkeit, Professionalität und Nachverfolgung: unsere drei Qualitätssäulen.', items: [{ title: 'Verfügbarkeit', desc: 'Service Tag und Nacht, 7 Tage die Woche, WhatsApp- und Telefon-Support.' }, { title: 'Professionell', desc: 'Geschultes, identifizierbares Team, passende Ausrüstung, klare Qualitätsverfahren.' }, { title: 'Kundenbetreuung', desc: 'Kontrolle nach dem Eingriff, dokumentierte Fotos und Feedback im Verbesserungsplan.' }] },
...
const AR_ITEMS = makeItems([
  ...
  { id: 'entretien-bureaux', title: 'تنظيف المكاتب', description: 'تنظيف مهني منتظم للمكاتب والمحلات والعيادات والمدارس. عقود يومية أو أسبوعية أو شهرية مع تقارير مصورة ومراقبة جودة ميدانية ومشرف مخصص.', sla: 'يومي / أسبوعي', badge: 'عقد احترافي', bullets: ['فريق معرّف بزي TAOMAN', 'منتجات صديقة للبيئة ومعدات مهنية', 'تقرير شهري ومراقبة جودة'], priceFrom: 'حسب العرض' },
  { id: 'mecanique', title: 'ميكانيكا السيارات', description: 'ورشة TAOMAN متعددة العلامات: صيانة وقائية، تغيير زيت، فرامل، تعليق، قابض، تكييف السيارات، تشخيص OBD. عقود أساطيل مع سجل صيانة لكل مركبة.', sla: 'عرض خلال 24 ساعة', badge: 'ورشة احترافية', bullets: ['تشخيص إلكتروني متعدد العلامات', 'قطع جديدة أو مجددة', 'متابعة الأسطول بسجل رقمي'], priceFrom: 'عرض شفاف' },
...
const AR_DETAILED_ITEMS = [
  ...
  { id: 'entretien-bureaux', title: 'تنظيف المكاتب', intro: 'بيئة عمل نظيفة تعزز الإنتاجية. عقودنا مصممة للاندماج دون تعطيل نشاطكم.', points: ['زيارة يومية (قبل الافتتاح) أو أسبوعية أو كل أسبوعين حسب الحاجة.', 'خدمات: أرضيات، أسطح، دورات مياه، زجاج، إفراغ سلال، تعقيم نقاط اللمس.', 'فرق بزي TAOMAN معرّف ومشرف مخصص متاح 24/7.', 'تقرير شهري بصور قبل/بعد، متابعة جودة وخطة تحسين ربع سنوية.'] },
...
const AR = {
  ...
  detailed: { eyebrow: 'ما بعد عرض السعر', description: 'ما بعد عرض السعر، نؤمن بالشفافية: هكذا نعمل، ما نقدمه، ولماذا يجدد عملاؤنا عقودهم مع TAOMAN Group Investment.', items: AR_DETAILED_ITEMS },
...
const ZH_ITEMS = makeItems([
  { id: 'lavage', title: '汽车与摩托车清洗', description: '优质内外清洁、玻璃、轮毂、轮胎、车身抛光。TAOMAN 中心或上门移动服务面向个人，企业及机构多车车队合同。', sla: '45 – 90 分钟', badge: '热门', bullets: ['全面外部+内部清洗', '抛光、上光与车身保护', '车队合同含每周排程'], priceFrom: '起价 3 500 FCFA' },
  ...
  { id: 'entretien-bureaux', title: '办公室保洁', description: '办公室、商铺、诊所及学校定期专业清洁。日/周/月合同，含照片报告、现场质量管控及专属督导。', sla: '每日/每周', badge: '专业合同', bullets: ['着 TAOMAN 制服的可识别团队', '环保产品与专业设备', '月度报告与质量检查'], priceFrom: '询价' },
  { id: 'mecanique', title: '汽车维修', description: 'TAOMAN 多品牌车间：预防性保养、换油、制动、悬挂、离合器、汽车空调、OBD 电子诊断。车队合同含每车维保记录。', sla: '24 小时报价', badge: '专业车间', bullets: ['多品牌电子诊断', '全新或翻新配件', '车队数字维保记录跟踪'], priceFrom: '透明报价' },
...
const ZH_DETAILED_ITEMS = [
  { id: 'lavage', title: '汽车与摩托车清洗', intro: 'TAOMAN 洗车中心配备专业设备、适配各车身类型的产品及培训人员。', points: ['三种套餐：快捷（15 分钟）、高级（45 分钟内外）、全套（90 分钟含抛光与保护）。', '预约上门移动服务，团队自带水与设备。', '企业月度车队合同：递减价格、固定排程、照片报告。', '认证可降解产品与循环用水——真正的环保实践。'] },
  ...
  { id: 'entretien-bureaux', title: '办公室保洁', intro: '洁净工作环境提升生产力。我们的合同设计为不打断您的日常运营。', points: ['每日（开业前）、每周或每两周上门，按需定制。', '服务含：地面、台面、卫生间、玻璃、倒垃圾、接触点消毒。', '着可识别 TAOMAN 制服团队，专属督导 24/7 可联系。', '月度报告含前后照片、质量跟踪及季度改进计划。'] },
  ...
  { id: 'audits', title: '审计与报告', intro: 'TAOMAN 将运营与财务专长服务于需要透明与结构化的多哥中小企业、投资者及机构。审计产出具体行动计划，报告符合 SYSCOA 与 CEDEAO。', points: ['全面财务审计：账目分析、现金流、隐性风险及 90 天整改建议。', '运营审计：流程审查、现场质量、人力、内部合规及风险图谱。', '投资者报告：月度仪表盘、季度 PDF、KPI、偏差预警及年度合并报告。', 'KYC 合规：身份核验、反洗钱、SYSCOA、CEDEAO 及机构投资者材料准备。', '治理支持：董事会筹备、纪要、审计委员会及高管财务阅读培训。', '数字工具：安全门户下载报告、实时 KPI 及临界阈值 WhatsApp 通知。'] },
];

const ZH = {
  items: ZH_ITEMS,
  labels: { timeLabel: '工期', priceLabel: '价格', priceFromFallback: '询价', requestQuoteCta: '索取报价', badgeAvailable: '可预约', badgeSoon: '即将推出' },
  detailed: { eyebrow: '超越报价', description: '超越报价，我们坚持透明：我们的工作方式、包含内容，以及客户为何与 TAOMAN Group Investment 续约。', items: ZH_DETAILED_ITEMS },
  ...
  whyUs: { eyebrow: '为何选择 TAOMAN', title: '三项简单承诺', description: '可用性、专业性与跟进：我们的三大质量支柱。', items: [{ title: '可用性', desc: '日夜服务，每周 7 天，WhatsApp 与电话支持。' }, { title: '专业', desc: '培训可识别团队、适配设备、清晰质量流程。' }, { title: '客户跟进', desc: '服务后检查、存档照片及反馈纳入改进计划。' }] },
