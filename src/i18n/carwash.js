...
const CARWASH = {
  FR: {
    ...
    process: {
      ...
      steps: [
        { num: '01', title: 'Demande de devis', desc: "Vous remplissez le formulaire ou nous contactez par téléphone. Nous notons le type de véhicule, l'état, l'urgence et le lieu d'intervention souhaité (centre TAOMAN ou domicile)." },
    ...
    location: {
      ...
      title: 'Lavage à domicile ou au centre TAOMAN : à vous de choisir.',
      description:
    ...
    form: {
      ...
      fields: {
        ...
        wish: { label: 'Vous souhaitez', options: ['Un lavage à domicile', 'Au centre de lavage TAOMAN Group Investment'] },
  ...
  EN: {
    intro: {
      ...
      paragraphs: [
        'TAOMAN Group Investment operates a premium car wash service for individuals, corporate fleets and investors who want to preserve their vehicles\' value. Every service is delivered by trained teams, with professional equipment and products chosen for effectiveness and respect for the bodywork.',
    ...
    process: {
      ...
      steps: [
        { num: '01', title: 'Quote request', desc: 'You fill in the form or contact us by phone. We note the vehicle type, condition, urgency and preferred location (TAOMAN centre or at home).' },
    ...
    location: {
      ...
      title: 'At home or at the TAOMAN centre: your choice.',
    ...
    form: {
      ...
      fields: {
        ...
        wish: { label: 'You would like', options: ['An at-home wash', 'At the TAOMAN Group Investment wash centre'] },
  ...
  ES: {
    ...
    process: {
      ...
      steps: [
        { num: '01', title: 'Solicitud de presupuesto', desc: 'Rellena el formulario o nos contactas por teléfono. Anotamos el tipo de vehículo, el estado, la urgencia y el lugar de intervención (centro TAOMAN o domicilio).' },
    ...
    location: {
      eyebrow: '¿Dónde desea ser lavado?', title: 'Lavado a domicilio o en el centro TAOMAN: usted elige.',
    ...
    form: {
      ...
      fields: {
        ...
        wish: { label: 'Desea', options: ['Un lavado a domicilio', 'En el centro de lavado TAOMAN Group Investment'] },
  ...
  PT: {
    intro: {
      ...
      paragraphs: [
        'A TAOMAN Group Investment opera um serviço de lavagem automóvel premium para particulares, frotas empresariais e investidores que desejam manter o valor dos seus veículos. Cada prestação é realizada por equipas formadas, com material profissional e produtos selecionados pela eficácia e respeito pela carroceria.',
    ...
    process: {
      ...
      steps: [
        { num: '01', title: 'Pedido de orçamento', desc: 'Preenche o formulário ou contacta-nos por telefone. Registamos o tipo de veículo, o estado, a urgência e o local de intervenção (centro TAOMAN ou domicílio).' },
    ...
    location: {
      eyebrow: 'Onde deseja ser lavado?', title: 'Lavagem ao domicílio ou no centro TAOMAN: à sua escolha.',
    ...
    form: {
      ...
      fields: {
        ...
        wish: { label: 'Deseja', options: ['Uma lavagem ao domicílio', 'No centro de lavagem TAOMAN Group Investment'] },
  ...
  DE: {
    intro: {
      ...
      paragraphs: [
        'TAOMAN Group Investment bietet einen Premium-Autowaschservice für Privatkunden, Firmenflotten und Investoren, die den Wert ihrer Fahrzeuge erhalten möchten. Jede Leistung wird von geschulten Teams mit professioneller Ausrüstung und sorgfältig ausgewählten Produkten durchgeführt.',
    ...
    process: {
      ...
      steps: [
        { num: '01', title: 'Angebotsanfrage', desc: 'Sie füllen das Formular aus oder kontaktieren uns telefonisch. Wir notieren Fahrzeugtyp, Zustand, Dringlichkeit und gewünschten Ort (TAOMAN-Zentrum oder vor Ort).' },
    ...
    location: {
      eyebrow: 'Wo möchten Sie gewaschen werden?', title: 'Vor Ort oder im TAOMAN-Zentrum: Sie entscheiden.',
    ...
    form: {
      ...
      fields: {
        ...
        wish: { label: 'Sie wünschen', options: ['Eine Wäsche vor Ort', 'Im Waschzentrum TAOMAN Group Investment'] },
  ...
  AR: {
    intro: {
      ...
      paragraphs: [
        'تقدّم TAOMAN Group Investment خدمة غسيل سيارات فاخرة للأفراد وأساطيل الشركات والمستثمرين الراغبين في الحفاظ على قيمة مركباتهم. تُنفَّذ كل خدمة بواسطة فرق مُدرَّبة، بمعدات احترافية ومنتجات مختارة لفعاليتها واحترامها للهيكل.',
    ...
    process: {
      ...
      steps: [
        { num: '01', title: 'طلب عرض سعر', desc: 'تملأ النموذج أو تتصل بنا هاتفياً. نُسجّل نوع المركبة وحالتها والاستعجال ومكان التدخل (مركز TAOMAN أو المنزل).' },
    ...
    location: {
      eyebrow: 'أين تريد الغسيل؟', title: 'في المنزل أو في مركز TAOMAN: أنت تختار.',
      ...
      center: { title: 'مركز غسيل TAOMAN', description: 'يضم مركزنا معدات ثقيلة: ضغط عالٍ صناعي، أذرع شفط، مناطق مغطاة ومضاءة. تنتظر في مساحة مخصّصة أثناء معالجة مركبتك.', bullets: ['معدات احترافية أقوى', 'أسعار أقل من الخدمة المنزلية', 'منطقة انتظار مريحة', 'متاح بدون موعد (حسب الازدحام)'] },
    },
    form: {
      ...
      fields: {
        ...
        wish: { label: 'ترغب في', options: ['غسيل في المنزل', 'في مركز غسيل TAOMAN Group Investment'] },
    ...
    sidebar: { eyebrow: 'لماذا TAOMAN؟', title: 'خدمة مصممة لعمر مركبتك', description: 'لا نبيع غسيلاً فحسب: نبيع عناية منتظمة تحمي الهيكل والمقصورة وقيمة إعادة البيع.', equipmentTitle: 'معدات احترافية', equipmentDesc: 'ضغط عالٍ مُتحكَّم به، مكانس صناعية، قفازات ميكروفايبر معتمدة، منتجات مناسبة للمواد الحديثة.' },
    faq: {
      eyebrow: 'الأسئلة الشائعة', title: 'أسئلتكم، إجاباتنا الواضحة',
      items: [
        { question: 'ما الفرق بين غسيل تقليدي وغسيل TAOMAN؟', answer: 'الغسيل التقليدي غالباً يقتصر على الماء والرغوة. غسيل TAOMAN يعتمد على قائمة تحقق ومنتجات مناسبة للمادة ومراقبة جودة وسياسة إعادة العمل عند عدم الرضا. نُعامل مركبتك كأنها لنا.' },
  ...
  ZH: {
    intro: {
      ...
      paragraphs: [
        'TAOMAN Group Investment 为个人、企业车队和希望保持车辆价值的投资人提供高端洗车服务。每项服务均由经过培训的团队完成，配备专业设备和兼顾效果与车身保护的产品。',
    ...
    process: {
      ...
      steps: [
        { num: '01', title: '索取报价', desc: '填写表格或致电联系我们。我们记录车型、状况、紧急程度及希望的服务地点（TAOMAN 中心或上门）。' },
    ...
    location: {
      eyebrow: '您希望在哪里洗车？', title: '上门洗车或 TAOMAN 中心：由您选择。',
      ...
      center: { title: 'TAOMAN 洗车中心', description: '中心配备重型设备：工业高压、吸尘臂、有顶有光的工位。您在专属休息区等候车辆处理。', bullets: ['更强大的专业设备', '价格比上门更优惠', '舒适的等候区', '无需预约（视客流量）'] },
    },
    form: {
      ...
      fields: {
        ...
        wish: { label: '您希望', options: ['上门洗车', '在 TAOMAN Group Investment 洗车中心'] },
    ...
    sidebar: { eyebrow: '为什么选择 TAOMAN？', title: '为车辆全生命周期而设计的服务', description: '我们不仅销售一次清洗：我们提供定期护理，保护车身、座舱和转售价值。', equipmentTitle: '专业设备', equipmentDesc: '可控高压、工业吸尘器、认证超细纤维手套、适配现代材料的产品。' },
    faq: {
      eyebrow: '洗车常见问题', title: '您的问题，我们清晰的回答',
      items: [
        { question: '普通洗车和 TAOMAN 洗车有何不同？', answer: '普通洗车往往只是水和泡沫。TAOMAN 洗车遵循检查清单、适配材料的产品、质量检验以及不满意免费返工政策。我们把您的车当作自己的车。' },
