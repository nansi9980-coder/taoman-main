...
const FAQ_FR = {
  ui: {
    ...
    intro:
      "Tout ce qu'il faut savoir sur le Groupe TAOMAN GROUP INVESTMENTS et sur notre programme d'investissement TGI : rendement, risque, sécurité, processus.",
  ...
  items: [
    {
      ...
      answer:
        "TAOMAN GROUP INVESTMENTS est un groupe togolais multi-activités. Il combine 4 services opérationnels (Lavage automobile, Déménagement, Entretien de bureaux, Transport) et un programme d'investissement participatif baptisé TGI ouvert sur sept domaines stratégiques (Logistique & Transports, Agro Business, Commerce général, BTP & Immobilier, Numérique & Services, Marketing International, Formation & Éducation financière).",
    },
    {
      category: 'groupe',
    ...
    {
      category: 'investissement',
      question: "Quelle est la durée d'un investissement TAOMAN GROUP INVESTMENTS ?",
      answer:
    ...
    },
    {
      ...
      answer:
        "Oui. TAOMAN GROUP INVESTMENTS est une société togolaise régulièrement enregistrée, fiscalement à jour, avec opérations contractualisées et facturation conforme.",
    },
    {
      category: 'securite',
...
const FAQ_EN = {
  ui: {
    ...
    intro:
      'Everything you need to know about TAOMAN GROUP INVESTMENTS and our TGI investment program: returns, risk, security and process.',
  ...
  items: [
    {
      category: 'groupe',
      question: 'What is TAOMAN GROUP INVESTMENTS?',
      answer:
        'TAOMAN GROUP INVESTMENTS is a multi-activity Togolese group combining four operational services (car wash, moving, office cleaning, transport) and a participatory investment program called TGI across seven strategic domains (logistics, agribusiness, trade, construction, digital, international marketing and financial education).',
    },
    {
      category: 'groupe',
    ...
    {
      category: 'investissement',
      question: 'How long is a TAOMAN GROUP INVESTMENTS investment?',
      answer:
    ...
    },
    {
      ...
      answer:
        'Yes. TAOMAN GROUP INVESTMENTS is duly registered in Togo, tax compliant, with contracted operations and proper invoicing.',
    },
    {
      category: 'securite',
...
const FAQ_ES = {
  ui: {
    ...
    intro: 'Todo sobre el Grupo TAOMAN GROUP INVESTMENTS y el programa TGI: rendimiento, riesgo, seguridad y proceso.',
  ...
  items: FAQ_EN.items.map((item, i) => ({
    ...item,
    question: [
      '¿Qué es TAOMAN GROUP INVESTMENTS?',
...
const FAQ_PT = {
  ...
  ui: {
    ...
    intro: 'Tudo sobre o Grupo TAOMAN GROUP INVESTMENTS e o programa TGI: rendimento, risco, segurança e processo.',
...
const FAQ_DE = {
  ...
  ui: {
    ...
    intro: 'Alles über TAOMAN GROUP INVESTMENTS und das TGI-Programm: Rendite, Risiko, Sicherheit und Ablauf.',
...
const FAQ_AR = {
  ...
  ui: {
    ...
    intro: 'كل ما يجب معرفته عن مجموعة TAOMAN GROUP INVESTMENTS وبرنامج TGI: العائد والمخاطر والأمان والعملية.',
...
const FAQ_ZH = {
  ...
  ui: {
    ...FAQ_EN.ui,
    title: '常见问题',
    intro: '关于 TAOMAN GROUP INVESTMENTS 集团与 TGI 投资计划：收益、风险、安全与流程。',
