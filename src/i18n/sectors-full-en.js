/**
 * Contenus longs secteurs (EN) — utilisés pour toutes les langues hors FR jusqu'à traduction CMS.
 */
export const SECTORS_FULL_EN = {
  'logistique-transports': {
    ...
    goal:
      'Build a leading private logistics operator in Togo serving individuals and businesses with regular revenue for investors.',
    perimetre:
      'Lomé, major Togolese cities and ECOWAS corridors. Assets include trucks, vans, utilities, motorcycles, maintenance workshops and urban hubs.',
    documents: [
      'Logistics market study Togo & ECOWAS corridor',
      'Fleet acquisition and financing plan',
      'Unit economics per vehicle',
      'Maintenance and operational reporting plan',
    ],
    cout: '€ 1 – 5 million',
  ...
  'agro-business': {
    ...
    perimetre:
      'Maritime, Plateaux, Central and Kara regions. Priority crops: vegetables, cereals, poultry, soy, cashew and food processing.',
    documents: [
      'Value chain studies per crop',
      'Economics per model farm',
      'Processing and HACCP plan',
  ...
  'commerce-general': {
    ...
    goal:
      'Build scalable distribution and retail platforms with transparent unit economics for investors.',
    perimetre: 'Lomé, Kara, Sokodé and cross-border retail corridors.',
  ...
  'btp-immobilier': {
    ...
    goal:
      'Deliver quality assets with controlled costs, clear timelines and investor reporting.',
    perimetre: 'Lomé, Kara, coastal and peri-urban zones.',
  ...
  'numerique-services': {
    ...
    goal:
      'Fund digital products with recurring revenue and measurable KPIs for investors.',
    perimetre: 'Togo and ECOWAS digital markets.',
  ...
  'marketing-international': {
    intro:
      'International marketing accelerates brand reach, client acquisition and export readiness for Togolese businesses.',
    context:
      'Regional and global markets require structured branding, performance campaigns and B2B lead generation.',
    goal:
      'Deploy measurable marketing programs linking local operators to regional and international clients.',
    perimetre: 'Togo, ECOWAS and target export markets.',
