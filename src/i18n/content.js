...
const CONTENT = {
  FR: {
    ...
    about: {
      seoDescription:
        "Découvrez TAOMAN GROUP INVESTMENTS : mission, vision, valeurs, gouvernance et leaders. Partenaire stratégique pour l'investissement et les services au Togo.",
      ...
      governance: {
        ...
        description:
          "TAOMAN GROUP INVESTMENTS opère sous une gouvernance institutionnelle stricte alignée sur les standards SYSCOA et CEDEAO : organes décisionnels indépendants, contrôles internes et reporting structuré.",
      ...
      stats: {
        eyebrow: 'En chiffres',
        title: "TAOMAN GROUP INVESTMENTS en un coup d'œil",
        items: [
    ...
    faq: {
      seoDescription:
        "Foire aux questions TAOMAN GROUP INVESTMENTS : investissement, services opérationnels, KYC, reporting, parcours client.",
      hero: {
    ...
    sectors: {
      ...
      brief: {
        ...
        description:
          "Pour chaque secteur, TAOMAN GROUP INVESTMENTS définit le profil de risque, le ticket minimum, la durée cible, les indicateurs suivis et les preuves d'exécution attendues sur le terrain.",
        labels: [
      ...
      detail: {
        sectorLabel: 'Secteur',
        operatedBy: 'Opéré par TAOMAN GROUP INVESTMENTS',
        contactUs: 'Nous contacter',
        submitProject: 'Soumettre un projet',
        contactInvest: 'Nous contacter pour investir',
        talkAdvisor: 'Discuter avec un conseiller',
        submitYourProject: 'Soumettre votre projet',
        whyInvest: 'Pourquoi TAOMAN GROUP INVESTMENTS investit dans ce secteur',
        ...
        scopeTitle: 'Où et comment TAOMAN GROUP INVESTMENTS opère',
        documentsTitle: 'Documents disponibles sur demande',
        aspectsEyebrow: 'Aspects opérationnels',
        aspectsTitle: 'Comment TAOMAN GROUP INVESTMENTS sécurise chaque projet',
        ...
        opportunitiesTitle: 'Les projets que TAOMAN GROUP INVESTMENTS vise',
        phasesEyebrow: 'Calendrier projet',
        phasesTitle: 'Les 4 phases de chaque projet TAOMAN GROUP INVESTMENTS',
        advantageBullets: [
          'Marché local concret et identifié',
          'Opérations pilotées par les équipes TAOMAN GROUP INVESTMENTS',
        ...
        tagFallback: 'Secteur',
        seoServiceSuffix: 'Service TAOMAN GROUP INVESTMENTS',
      },
    },
    invest: {
      ...
      guarantee: { eyebrow: 'Engagement TAOMAN GROUP INVESTMENTS', title: 'Ce que nous garantissons aux investisseurs' },
      help: { eyebrow: "Centre d'aide", title: 'Vos questions, nos réponses' },
    },
    tgi: {
      seoDescription: 'Programme TGI de TAOMAN GROUP INVESTMENTS : investissement structuré au Togo avec ticket dès 500 000 FCFA, projection 10 mois, reporting investisseur.',
      hero: { badge: "Programme d'investissement TGI", title: 'Faites fructifier votre capital avec TAOMAN GROUP INVESTMENTS' },
    ...
    moving: {
      ...
      commitments: { eyebrow: 'Nos engagements', title: 'Pourquoi TAOMAN GROUP INVESTMENTS pour votre déménagement' },
      process: { eyebrow: 'Notre méthode', title: 'Comment nous travaillons' },
    },
    carwash: {
      seoDescription: 'Devis lavage auto et moto TAOMAN GROUP INVESTMENTS : prestations en centre ou à domicile, formules intérieur, extérieur, complet, contrats flotte.',
    ...
    devisMoving: {
      seoDescription: 'Devis déménagement TAOMAN GROUP INVESTMENTS : particuliers, entreprises et commerces, intra-ville, inter-villes et international.',
    ...
    office: {
      seoDescription: 'Entretien de bureaux par TAOMAN GROUP INVESTMENTS : contrats sur mesure, équipes dédiées, produits respectueux et reporting qualité.',
    ...
    simulator: {
      seoDescription: 'Simulateur d’investissement TAOMAN GROUP INVESTMENTS : projetez votre rendement sur 10 mois avec intérêts composés.',
    ...
    submitProject: {
      seoDescription: 'Soumettez votre projet à TAOMAN GROUP INVESTMENTS : analyse sous 5 jours ouvrés, décision motivée, accompagnement structuré.',
      hero: { eyebrow: 'Soumettre un projet', title: 'Présentez votre projet à TAOMAN GROUP INVESTMENTS', description: 'Notre comité d’investissement étudie chaque dossier et revient vers vous sous 5 jours ouvrés.' },
    },
    auth: {
      ...
      register: { title: 'Créer un compte', subtitle: 'Rejoignez l’écosystème TAOMAN GROUP INVESTMENTS en quelques minutes.', firstName: 'Prénom', lastName: 'Nom', email: 'Adresse email', phone: 'Téléphone', password: 'Mot de passe', confirm: 'Confirmer le mot de passe', submit: 'Créer mon compte', hasAccount: 'Vous avez déjà un compte ?', signInLink: 'Se connecter' },
    ...
    legal: {
      seoDescription: 'Mentions légales TAOMAN GROUP INVESTMENTS : éditeur, hébergeur, propriété intellectuelle, données personnelles.',
    ...
    privacy: {
      seoDescription: 'Politique de confidentialité TAOMAN GROUP INVESTMENTS : collecte, traitement et protection de vos données personnelles.',
    ...
    terms: {
      seoDescription: "Conditions générales d'utilisation du site TAOMAN GROUP INVESTMENTS.",
    ...
    home: {
      ...
      hero: {
        ...
        badgeMain: 'Partenaire stratégique — TAOMAN GROUP INVESTMENTS',
        title: 'Excellence',
  ...
  EN: {
    ...
    about: {
      seoDescription:
        'Discover TAOMAN GROUP INVESTMENTS: mission, vision, values, governance and leadership. Strategic partner for investment and services in Togo.',
      title: 'TAOMAN GROUP INVESTMENTS: your strategic partner in Togo.',
      description:
      ...
      governance: {
        ...
        description:
          'TAOMAN GROUP INVESTMENTS operates under strict institutional governance aligned with SYSCOA and ECOWAS standards: independent decision-making bodies, internal controls and structured reporting.',
      ...
      timeline: {
        ...
        title: 'Our journey',
        items: [
          { year: '2018', event: 'Founding of TAOMAN GROUP INVESTMENTS' },
      ...
      stats: {
        eyebrow: 'In numbers',
        title: 'TAOMAN GROUP INVESTMENTS at a glance',
        items: [
      ...
      cta: { title: 'Join the TAOMAN GROUP INVESTMENTS ecosystem', description: 'Discover how we can contribute to your success.', button: 'Get started' },
    },
    contact: {
    ...
    faq: {
      seoDescription: 'TAOMAN GROUP INVESTMENTS frequently asked questions: investment, operational services, KYC, reporting, customer journey.',
    ...
    sectors: {
      ...
      brief: {
        ...
        description: 'For each sector, TAOMAN GROUP INVESTMENTS defines the risk profile, the minimum ticket, the target duration, the monitored indicators and the field execution evidence expected.',
        labels: [
      ...
      detail: {
        sectorLabel: 'Sector',
        operatedBy: 'Operated by TAOMAN GROUP INVESTMENTS',
        contactUs: 'Contact us',
        submitProject: 'Submit a project',
        contactInvest: 'Contact us to invest',
        talkAdvisor: 'Talk to an advisor',
        submitYourProject: 'Submit your project',
        whyInvest: 'Why TAOMAN GROUP INVESTMENTS invests in this sector',
        ...
        scopeTitle: 'Where and how TAOMAN GROUP INVESTMENTS operates',
        documentsTitle: 'Documents available on request',
        aspectsEyebrow: 'Operational aspects',
        aspectsTitle: 'How TAOMAN GROUP INVESTMENTS secures each project',
        highlightsEyebrow: 'Focus areas',
        highlightsTitle: 'What we concretely fund',
        opportunitiesEyebrow: 'Identified opportunities',
        opportunitiesTitle: 'Projects TAOMAN GROUP INVESTMENTS targets',
        phasesEyebrow: 'Project timeline',
        phasesTitle: 'The 4 phases of every TAOMAN GROUP INVESTMENTS project',
        advantageBullets: [
          'Concrete, identified local market',
          'Operations run by TAOMAN GROUP INVESTMENTS teams',
        ...
        ticketValue: '500K FCFA',
        tagFallback: 'Sector',
        seoServiceSuffix: 'TAOMAN GROUP INVESTMENTS Service',
      },
    },
    invest: {
      ...
      guarantee: { eyebrow: 'TAOMAN GROUP INVESTMENTS commitment', title: 'What we guarantee to investors' },
      help: { eyebrow: 'Help center', title: 'Your questions, our answers' },
    },
    tgi: {
      seoDescription: 'TAOMAN GROUP INVESTMENTS TGI program: structured investment in Togo from 500,000 CFA, 10-month projection, investor reporting.',
      hero: { badge: 'TGI Investment Program', title: 'Grow your capital with TAOMAN GROUP INVESTMENTS' },
      ...
      cta: { title: 'Ready to invest with TAOMAN GROUP INVESTMENTS?', description: 'An advisor will introduce you to the program and your opportunities within 48 hours.', button: 'Talk to an advisor' },
    },
    moving: {
      seoDescription: 'TAOMAN GROUP INVESTMENTS moving personnel and fleet: adapted vehicles, trained teams, services for individuals, businesses and shops.',
      ...
      commitments: { eyebrow: 'Our commitments', title: 'Why TAOMAN GROUP INVESTMENTS for your move' },
      process: { eyebrow: 'Our method', title: 'How we work' },
    },
    carwash: {
      seoDescription: 'TAOMAN GROUP INVESTMENTS car and motorcycle wash quote: in-center or at-home services, interior, exterior, complete packages, fleet contracts.',
    ...
    devisMoving: {
      seoDescription: 'TAOMAN GROUP INVESTMENTS moving quote: individuals, businesses and shops, intra-city, inter-city and international.',
    ...
    office: {
      seoDescription: 'TAOMAN GROUP INVESTMENTS office maintenance: custom contracts, dedicated teams, eco-friendly products and quality reporting.',
    ...
    simulator: {
      seoDescription: 'TAOMAN GROUP INVESTMENTS investment simulator: project your return over 10 months with compound interest.',
    ...
    submitProject: {
      seoDescription: 'Submit your project to TAOMAN GROUP INVESTMENTS: analysis within 5 business days, motivated decision, structured support.',
      hero: { eyebrow: 'Submit a project', title: 'Present your project to TAOMAN GROUP INVESTMENTS', description: 'Our investment committee studies each file and gets back to you within 5 business days.' },
    },
    auth: {
      ...
      register: { title: 'Create an account', subtitle: 'Join the TAOMAN GROUP INVESTMENTS ecosystem in a few minutes.', firstName: 'First name', lastName: 'Last name', email: 'Email address', phone: 'Phone', password: 'Password', confirm: 'Confirm password', submit: 'Create my account', hasAccount: 'Already have an account?', signInLink: 'Sign in' },
    ...
    legal: {
      seoDescription: 'TAOMAN GROUP INVESTMENTS legal notice: publisher, host, intellectual property, personal data.',
    ...
    privacy: {
      seoDescription: 'TAOMAN GROUP INVESTMENTS privacy policy: collection, processing and protection of your personal data.',
    ...
    terms: {
      seoDescription: 'TAOMAN GROUP INVESTMENTS website terms of use.',
    ...
    home: {
      ...
      hero: {
        ...
        badgeMain: 'Strategic partner — TAOMAN GROUP INVESTMENTS',
        title: 'Excellence',
      ...
      realisations: {
        ...
        footerText:
          'TAOMAN GROUP INVESTMENTS turns every field achievement into lasting value: management, execution and professional reporting.',
  ...
  ES: {
    ...
    about: {
      seoDescription: 'Descubra TAOMAN GROUP INVESTMENTS: misión, visión, valores, gobernanza y liderazgo. Socio estratégico para la inversión y los servicios en Togo.',
      title: 'TAOMAN GROUP INVESTMENTS: su socio estratégico en Togo.',
      ...
      governance: {
        ...
        description: 'TAOMAN GROUP INVESTMENTS opera bajo una gobernanza institucional estricta alineada con los estándares UEMOA/CEDEAO: órganos independientes, controles internos y reporting estructurado.',
      ...
      timeline: {
        ...
        items: [
          { year: '2018', event: 'Fundación de TAOMAN GROUP INVESTMENTS' },
      ...
      stats: {
        eyebrow: 'En cifras',
        title: 'TAOMAN GROUP INVESTMENTS de un vistazo',
        items: [
      ...
      cta: { title: 'Únase al ecosistema TAOMAN GROUP INVESTMENTS', description: 'Descubra cómo podemos contribuir a su éxito.', button: 'Comenzar ahora' },
    },
    contact: {
    ...
    faq: {
      seoDescription: 'Preguntas frecuentes de TAOMAN GROUP INVESTMENTS: inversión, servicios operativos, KYC, reporting, recorrido del cliente.',
    ...
    sectors: {
      ...
      brief: {
        ...
        description: 'Para cada sector, TAOMAN GROUP INVESTMENTS define el perfil de riesgo, el ticket mínimo, la duración objetivo, los indicadores seguidos y las evidencias de ejecución esperadas en el terreno.',
        labels: [
          { label: 'Ticket', value: '500K FCFA' },
    ...
    invest: {
      ...
      guarantee: { eyebrow: 'Compromiso TAOMAN GROUP INVESTMENTS', title: 'Lo que garantizamos a los inversores' },
      help: { eyebrow: 'Centro de ayuda', title: 'Sus preguntas, nuestras respuestas' },
    },
    tgi: {
      seoDescription: 'Programa TGI de TAOMAN GROUP INVESTMENTS: inversión estructurada en Togo desde 500.000 FCFA, proyección a 10 meses, informes para inversores.',
      hero: { badge: 'Programa de inversión TGI', title: 'Haga fructificar su capital con TAOMAN GROUP INVESTMENTS' },
    ...
    moving: {
      ...
      commitments: { eyebrow: 'Nuestros compromisos', title: 'Por qué TAOMAN GROUP INVESTMENTS para su mudanza' },
      process: { eyebrow: 'Nuestro método', title: 'Cómo trabajamos' },
    },
    carwash: {
      seoDescription: 'Presupuesto de lavado de autos y motos TAOMAN GROUP INVESTMENTS: servicios en centro o a domicilio, fórmulas interior, exterior, completo, contratos de flota.',
    ...
    devisMoving: {
      seoDescription: 'Presupuesto de mudanza TAOMAN GROUP INVESTMENTS: particulares, empresas y comercios, intra-ciudad, inter-ciudades e internacional.',
    ...
    office: {
      seoDescription: 'Mantenimiento de oficinas TAOMAN GROUP INVESTMENTS: contratos a medida, equipos dedicados, productos respetuosos e informes de calidad.',
    ...
    simulator: {
      seoDescription: 'Simulador de inversión TAOMAN GROUP INVESTMENTS: proyecte su rendimiento a 10 meses con interés compuesto.',
    ...
    submitProject: {
      seoDescription: 'Envíe su proyecto a TAOMAN GROUP INVESTMENTS: análisis en 5 días hábiles, decisión motivada, acompañamiento estructurado.',
      hero: { eyebrow: 'Enviar un proyecto', title: 'Presente su proyecto a TAOMAN GROUP INVESTMENTS', description: 'Nuestro comité de inversión estudia cada expediente y le responde en 5 días hábiles.' },
    },
    auth: {
      ...
      register: { title: 'Crear una cuenta', subtitle: 'Únase al ecosistema TAOMAN GROUP INVESTMENTS en pocos minutos.', firstName: 'Nombre', lastName: 'Apellido', email: 'Correo electrónico', phone: 'Teléfono', password: 'Contraseña', confirm: 'Confirmar contraseña', submit: 'Crear mi cuenta', hasAccount: '¿Ya tiene una cuenta?', signInLink: 'Iniciar sesión' },
    ...
    legal: {
      seoDescription: 'Aviso legal TAOMAN GROUP INVESTMENTS: editor, anfitrión, propiedad intelectual, datos personales.',
    ...
    privacy: {
      seoDescription: 'Política de privacidad TAOMAN GROUP INVESTMENTS: recopilación, tratamiento y protección de sus datos personales.',
    ...
    terms: {
      seoDescription: 'Condiciones generales de uso del sitio TAOMAN GROUP INVESTMENTS.',
    ...
    home: {
      ...
      hero: {
        ...
        badgeMain: 'Socio estratégico — TAOMAN GROUP INVESTMENTS',
        title: 'Excelencia',
  ...
  PT: {
    ...
    about: {
      seoDescription: 'Descubra TAOMAN GROUP INVESTMENTS: missão, visão, valores, governança e liderança. Parceiro estratégico para o investimento e serviços no Togo.',
      title: 'TAOMAN GROUP INVESTMENTS: o seu parceiro estratégico no Togo.',
      ...
      governance: {
        ...
        description: 'A TAOMAN GROUP INVESTMENTS opera sob governança institucional rigorosa alinhada com os padrões UEMOA/CEDEAO: órgãos independentes, controlos internos e reporting estruturado.',
      ...
      timeline: {
        ...
        items: [
          { year: '2018', event: 'Fundação da TAOMAN GROUP INVESTMENTS' },
      ...
      stats: {
        eyebrow: 'Em números',
        title: 'TAOMAN GROUP INVESTMENTS num relance',
        items: [
      ...
      cta: { title: 'Junte-se ao ecossistema TAOMAN GROUP INVESTMENTS', description: 'Descubra como podemos contribuir para o seu sucesso.', button: 'Começar agora' },
    },
    contact: {
    ...
    faq: {
      seoDescription: 'Perguntas frequentes da TAOMAN GROUP INVESTMENTS: investimento, serviços operacionais, KYC, reporting, percurso do cliente.',
    ...
    sectors: {
      ...
      brief: {
        ...
        description: 'Para cada setor, a TAOMAN GROUP INVESTMENTS define o perfil de risco, o ticket mínimo, a duração-alvo, os indicadores seguidos e as provas de execução esperadas no terreno.',
        labels: [
          { label: 'Ticket', value: '500K FCFA' },
    ...
    invest: {
      ...
      guarantee: { eyebrow: 'Compromisso TAOMAN GROUP INVESTMENTS', title: 'O que garantimos aos investidores' },
      help: { eyebrow: 'Centro de ajuda', title: 'Suas perguntas, nossas respostas' },
    },
    tgi: {
      seoDescription: 'Programa TGI da TAOMAN GROUP INVESTMENTS: investimento estruturado no Togo a partir de 500.000 FCFA, projeção de 10 meses, relatórios para investidores.',
      hero: { badge: 'Programa de investimento TGI', title: 'Faça fructificar o seu capital com a TAOMAN GROUP INVESTMENTS' },
    ...
    moving: {
      ...
      commitments: { eyebrow: 'Os nossos compromissos', title: 'Por que escolher a TAOMAN GROUP INVESTMENTS para a sua mudança' },
      process: { eyebrow: 'O nosso método', title: 'Como trabalhamos' },
    },
    carwash: {
      seoDescription: 'Orçamento de lavagem de automóveis e motos TAOMAN GROUP INVESTMENTS: serviços em centro ou ao domicílio, fórmulas interior, exterior, completas, contratos de frota.',
    ...
    devisMoving: {
      seoDescription: 'Orçamento de mudanças TAOMAN GROUP INVESTMENTS: particulares, empresas e comércios, intra-cidade, inter-cidades e internacional.',
    ...
    office: {
      seoDescription: 'Manutenção de escritórios TAOMAN GROUP INVESTMENTS: contratos à medida, equipas dedicadas, produtos respeitadores e relatórios de qualidade.',
    ...
    jobs: {
      ...
      hero: { eyebrow: 'Carreiras', title: 'Junte-se às equipas TAOMAN GROUP INVESTMENTS', description: 'Descubra oportunidades para contribuir para um projeto com impacto económico real no Togo.' },
    },
    simulator: {
      seoDescription: 'Simulador de investimento TAOMAN GROUP INVESTMENTS: projete o seu rendimento em 10 meses com juros compostos.',
    ...
    submitProject: {
      seoDescription: 'Envie o seu projeto à TAOMAN GROUP INVESTMENTS: análise em 5 dias úteis, decisão fundamentada, acompanhamento estruturado.',
      hero: { eyebrow: 'Enviar um projeto', title: 'Apresente o seu projeto à TAOMAN GROUP INVESTMENTS', description: 'O nosso comité de investimento estuda cada processo e responde-lhe em 5 dias úteis.' },
    },
    auth: {
    ...
    legal: {
      seoDescription: 'Avisos legais TAOMAN GROUP INVESTMENTS: editor, anfitrião, propriedade intelectual, dados pessoais.',
    ...
    privacy: {
      seoDescription: 'Política de privacidade TAOMAN GROUP INVESTMENTS: recolha, tratamento e proteção dos seus dados pessoais.',
    ...
    terms: {
      seoDescription: 'Termos e condições de utilização do site TAOMAN GROUP INVESTMENTS.',
    ...
    home: {
      ...
      hero: {
        ...
        badgeMain: 'Parceiro estratégico — TAOMAN GROUP INVESTMENTS',
        title: 'Excelência',
  ...
  DE: {
    ...
    about: {
      seoDescription: 'Entdecken Sie TAOMAN GROUP INVESTMENTS: Mission, Vision, Werte, Governance und Führung. Strategischer Partner für Investitionen und Dienstleistungen in Togo.',
      title: 'TAOMAN GROUP INVESTMENTS: Ihr strategischer Partner in Togo.',
      ...
      governance: {
        ...
        description: 'TAOMAN GROUP INVESTMENTS arbeitet nach strengen institutionellen Governance-Grundsätzen, ausgerichtet an UEMOA- und ECOWAS-Standards: unabhängige Entscheidungsgremien, interne Kontrollen und strukturiertes Reporting.',
      ...
      timeline: {
        ...
        items: [
          { year: '2018', event: 'Gründung der TAOMAN GROUP INVESTMENTS' },
      ...
      stats: {
        eyebrow: 'In Zahlen',
        title: 'TAOMAN GROUP INVESTMENTS auf einen Blick',
        items: [
      ...
      cta: { title: 'Treten Sie dem TAOMAN GROUP INVESTMENTS-Ökosystem bei', description: 'Erfahren Sie, wie wir zu Ihrem Erfolg beitragen können.', button: 'Jetzt starten' },
    },
    contact: {
    ...
    faq: {
      seoDescription: 'Häufig gestellte Fragen zu TAOMAN GROUP INVESTMENTS: Investitionen, operative Dienste, KYC, Reporting, Kundenreise.',
    ...
    sectors: {
      ...
      brief: {
        ...
        description: 'Für jeden Sektor definiert TAOMAN GROUP INVESTMENTS das Risikoprofil, das Mindestticket, die Ziellaufzeit, die überwachten Indikatoren und die erwarteten Vor-Ort-Ausführungsnachweise.',
        labels: [
          { label: 'Ticket', value: '500K FCFA' },
    ...
    invest: {
      ...
      guarantee: { eyebrow: 'TAOMAN GROUP INVESTMENTS-Engagement', title: 'Was wir Investoren garantieren' },
      help: { eyebrow: 'Hilfezentrum', title: 'Ihre Fragen, unsere Antworten' },
    },
    tgi: {
      seoDescription: 'TGI-Programm von TAOMAN GROUP INVESTMENTS: strukturierte Investition in Togo ab 500.000 FCFA, 10-Monats-Projektion, Investor-Reporting.',
      hero: { badge: 'TGI-Investitionsprogramm', title: 'Lassen Sie Ihr Kapital mit TAOMAN GROUP INVESTMENTS fruchten' },
      ...
      cta: { title: 'Bereit, mit TAOMAN GROUP INVESTMENTS zu investieren?', description: 'Ein Berater stellt Ihnen das Programm und Ihre Möglichkeiten innerhalb von 48 Stunden vor.', button: 'Mit einem Berater sprechen' },
    },
    moving: {
      seoDescription: 'TAOMAN GROUP INVESTMENTS-Umzugspersonal und -flotte: angepasste Fahrzeuge, geschulte Teams, Dienstleistungen für Privatpersonen, Unternehmen und Geschäfte.',
      ...
      commitments: { eyebrow: 'Unsere Verpflichtungen', title: 'Warum TAOMAN GROUP INVESTMENTS für Ihren Umzug' },
      process: { eyebrow: 'Unsere Methode', title: 'Wie wir arbeiten' },
    },
    carwash: {
      seoDescription: 'TAOMAN GROUP INVESTMENTS-Auto- und Motorradwäsche-Angebot: Leistungen im Zentrum oder zu Hause, Pakete Innen, Außen, Komplett, Flottenverträge.',
    ...
    devisMoving: {
      seoDescription: 'TAOMAN GROUP INVESTMENTS-Umzugsangebot: Privatpersonen, Unternehmen und Geschäfte, innerstädtisch, zwischen Städten und international.',
    ...
    office: {
      seoDescription: 'TAOMAN GROUP INVESTMENTS-Büroreinigung: maßgeschneiderte Verträge, dedizierte Teams, umweltfreundliche Produkte und Qualitätsberichte.',
    ...
    simulator: {
      seoDescription: 'TAOMAN GROUP INVESTMENTS-Investitionssimulator: Projizieren Sie Ihre Rendite über 10 Monate mit Zinseszins.',
    ...
    submitProject: {
      seoDescription: 'Reichen Sie Ihr Projekt bei TAOMAN GROUP INVESTMENTS ein: Analyse innerhalb von 5 Werktagen, begründete Entscheidung, strukturierte Unterstützung.',
      hero: { eyebrow: 'Projekt einreichen', title: 'Stellen Sie Ihr Projekt TAOMAN GROUP INVESTMENTS vor', description: 'Unser Investitionsausschuss prüft jede Akte und meldet sich innerhalb von 5 Werktagen bei Ihnen.' },
    },
    auth: {
      ...
      register: { title: 'Konto erstellen', subtitle: 'Treten Sie dem TAOMAN GROUP INVESTMENTS-Ökosystem in wenigen Minuten bei.', firstName: 'Vorname', lastName: 'Nachname', email: 'E-Mail-Adresse', phone: 'Telefon', password: 'Passwort', confirm: 'Passwort bestätigen', submit: 'Mein Konto erstellen', hasAccount: 'Haben Sie bereits ein Konto?', signInLink: 'Anmelden' },
    ...
    legal: {
      seoDescription: 'TAOMAN GROUP INVESTMENTS Impressum: Herausgeber, Hoster, geistiges Eigentum, personenbezogene Daten.',
    ...
    privacy: {
      seoDescription: 'TAOMAN GROUP INVESTMENTS Datenschutzrichtlinie: Erhebung, Verarbeitung und Schutz Ihrer personenbezogenen Daten.',
    ...
    terms: {
      seoDescription: 'Nutzungsbedingungen der TAOMAN GROUP INVESTMENTS Website.',
    ...
    home: {
      ...
      hero: {
        ...
        badgeMain: 'Strategischer Partner — TAOMAN GROUP INVESTMENTS',
        title: 'Exzellenz',
  ...
  AR: {
    ...
    invest: {
      ...
      guarantee: { eyebrow: 'التزام TAOMAN GROUP INVESTMENTS', title: 'ما نضمنه للمستثمرين' },
      help: { eyebrow: 'مركز المساعدة', title: 'أسئلتكم، إجاباتنا' },
    },
    tgi: {
      seoDescription: 'برنامج TGI من TAOMAN GROUP INVESTMENTS: استثمار منظم في توغو ابتداءً من 500,000 فرنك أفريقي، توقع لمدة 10 أشهر، تقارير المستثمرين.',
      hero: { badge: 'برنامج الاستثمار TGI', title: 'اجعل رأس مالك يثمر مع TAOMAN GROUP INVESTMENTS' },
      ...
      cta: { title: 'مستعد للاستثمار مع TAOMAN GROUP INVESTMENTS؟', description: 'يقدم لك مستشار البرنامج وفرصك خلال 48 ساعة.', button: 'تحدث مع مستشار' },
    },
    moving: {
      seoDescription: 'فريق وأسطول النقل TAOMAN GROUP INVESTMENTS: مركبات مهيأة، فرق مدربة، خدمات للأفراد والشركات والمحلات.',
      ...
      commitments: { eyebrow: 'التزاماتنا', title: 'لماذا TAOMAN GROUP INVESTMENTS لنقل أمتعتك' },
      process: { eyebrow: 'منهجيتنا', title: 'كيف نعمل' },
    },
    carwash: {
      seoDescription: 'عرض غسيل السيارات والدراجات النارية TAOMAN GROUP INVESTMENTS: خدمات في المركز أو في المنزل، صيغ داخلية وخارجية وكاملة، عقود الأسطول.',
    ...
    devisMoving: {
      seoDescription: 'عرض النقل TAOMAN GROUP INVESTMENTS: للأفراد والشركات والمحلات، داخل المدينة وبين المدن ودولي.',
    ...
    office: {
      seoDescription: 'صيانة المكاتب TAOMAN GROUP INVESTMENTS: عقود مخصصة، فرق متفانية، منتجات صديقة للبيئة وتقارير الجودة.',
    ...
    simulator: {
      seoDescription: 'محاكي استثمار TAOMAN GROUP INVESTMENTS: توقع عائدك على مدى 10 أشهر مع الفائدة المركبة.',
      hero: { eyebrow: 'محاكي احترافي', title: 'حاكي استثمارك في TGI', description: 'احسب عائدك المتوقع بناءً على بطاقتك وأفقك.' },
    },
    submitProject: {
      seoDescription: 'قدم مشروعك إلى TAOMAN GROUP INVESTMENTS: تحليل خلال 5 أيام عمل، قرار مبرر، دعم منظم.',
      hero: { eyebrow: 'تقديم مشروع', title: 'قدم مشروعك إلى TAOMAN GROUP INVESTMENTS', description: 'لجنة الاستثمار لدينا تدرس كل ملف وترد عليك خلال 5 أيام عمل.' },
    },
    auth: {
      ...
      register: { title: 'إنشاء حساب', subtitle: 'انضم إلى نظام TAOMAN GROUP INVESTMENTS البيئي في بضع دقائق.', firstName: 'الاسم', lastName: 'اللقب', email: 'البريد الإلكتروني', phone: 'الهاتف', password: 'كلمة المرور', confirm: 'تأكيد كلمة المرور', submit: 'إنشاء حسابي', hasAccount: 'لديك حساب بالفعل؟', signInLink: 'تسجيل الدخول' },
    ...
    legal: {
      seoDescription: 'الإشعارات القانونية TAOMAN GROUP INVESTMENTS: الناشر، المضيف، الملكية الفكرية، البيانات الشخصية.',
    ...
    privacy: {
      seoDescription: 'سياسة الخصوصية TAOMAN GROUP INVESTMENTS: جمع ومعالجة وحماية بياناتك الشخصية.',
    ...
    terms: {
      seoDescription: 'الشروط العامة لاستخدام موقع TAOMAN GROUP INVESTMENTS.',
    ...
    home: {
      ...
      hero: {
        ...
        badgeMain: 'شريك استراتيجي — TAOMAN GROUP INVESTMENTS',
        title: 'التميز',
        subtitle: 'في كل خدمة',
  ...
  ZH: {
    ...
    about: {
      seoDescription: '了解 TAOMAN GROUP INVESTMENTS：使命、愿景、价值观、治理与领导力。多哥投资与服务的战略合作伙伴。',
      title: 'TAOMAN GROUP INVESTMENTS：您在多哥的战略合作伙伴。',
      ...
      governance: {
        eyebrow: '治理',
        title: '为投资者服务的严谨架构',
        description: 'TAOMAN GROUP INVESTMENTS 在 UEMOA/西非经共体标准下严格的机构治理下运作：独立决策机构、内部控制和结构化报告。',
      ...
      timeline: {
        ...
        title: '我们的历程',
        items: [
          { year: '2018', event: 'TAOMAN GROUP INVESTMENTS 成立' },
      ...
      stats: {
        eyebrow: '数据一览',
        title: 'TAOMAN GROUP INVESTMENTS 概览',
        items: [
          { number: '4', label: '服务板块' },
      ...
      cta: { title: '加入 TAOMAN GROUP INVESTMENTS 生态', description: '了解我们如何助力您的成功。', button: '立即开始' },
    },
    contact: {
    ...
    faq: {
      seoDescription: 'TAOMAN GROUP INVESTMENTS 常见问题：投资、运营服务、KYC、报告、客户旅程。',
    ...
    sectors: {
      ...
      brief: {
        eyebrow: '项目规范',
        title: '清晰的框架，可追溯的项目',
        description: '针对每个领域，TAOMAN GROUP INVESTMENTS 定义风险概况、最低门槛、目标期限、监控指标和现场执行证据要求。',
        labels: [
    ...
    invest: {
      ...
      guarantee: { eyebrow: 'TAOMAN GROUP INVESTMENTS承诺', title: '我们向投资者保证的内容' },
      help: { eyebrow: '帮助中心', title: '您的问题，我们的答案' },
    },
    tgi: {
      seoDescription: 'TAOMAN GROUP INVESTMENTS的TGI项目：在多哥进行结构化投资，起投金额50万非洲法郎，10个月预测，投资者报告。',
      hero: { badge: 'TGI投资项目', title: '让您的资本与TAOMAN GROUP INVESTMENTS一起增值' },
      ...
      cta: { title: '准备好与TAOMAN GROUP INVESTMENTS一起投资了吗？', description: '顾问将在48小时内向您介绍该项目和您的机会。', button: '与顾问交谈' },
    },
    moving: {
      seoDescription: 'TAOMAN GROUP INVESTMENTS搬家人员和车队：适应的车辆、训练有素的团队、为个人、企业和商店提供的服务。',
      ...
      commitments: { eyebrow: '我们的承诺', title: '为什么选择TAOMAN GROUP INVESTMENTS搬家' },
      process: { eyebrow: '我们的方法', title: '我们如何工作' },
    },
    carwash: {
      seoDescription: 'TAOMAN GROUP INVESTMENTS汽车和摩托车清洗报价：中心或上门服务、内部、外部、完整套餐、车队合同。',
      hero: { eyebrow: '汽车和摩托车清洗', title: '索取您的清洗报价', description: '高端清洗中心、移动团队和车队合同：选择符合您需求的套餐。' },
    },
    devisMoving: {
      seoDescription: 'TAOMAN GROUP INVESTMENTS搬家报价：个人、企业和商店，城内、城际和国际。',
      hero: { eyebrow: '搬家', title: '索取您的搬家报价', description: '24小时内提供个性化报价、专业团队、保险包含以及家具拆卸/重新组装。' },
    },
    office: {
      seoDescription: 'TAOMAN GROUP INVESTMENTS办公室维护：定制合同、专门团队、环保产品和质量报告。',
    ...
    jobs: {
      ...
      hero: { eyebrow: '职业', title: '加入TAOMAN GROUP INVESTMENTS团队', description: '发现为多哥具有真正经济影响的项目做出贡献的机会。' },
    },
    simulator: {
      seoDescription: 'TAOMAN GROUP INVESTMENTS投资模拟器：通过复利预测您10个月的回报。',
      hero: { eyebrow: '专业模拟器', title: '模拟您的TGI投资', description: '根据您的投资额和期限计算预计回报。' },
    },
    submitProject: {
      seoDescription: '向TAOMAN GROUP INVESTMENTS提交您的项目：5个工作日内分析、明确决定、结构化支持。',
      hero: { eyebrow: '提交项目', title: '向TAOMAN GROUP INVESTMENTS介绍您的项目', description: '我们的投资委员会研究每个档案，并在5个工作日内回复您。' },
    },
    auth: {
      ...
      register: { title: '创建账户', subtitle: '几分钟内加入TAOMAN GROUP INVESTMENTS生态系统。', firstName: '名字', lastName: '姓氏', email: '电子邮件地址', phone: '电话', password: '密码', confirm: '确认密码', submit: '创建我的账户', hasAccount: '已经有账户？', signInLink: '登录' },
      reset: { title: '重置密码', subtitle: '输入您的电子邮件地址以接收重置链接。', email: '电子邮件地址', submit: '发送链接', back: '返回登录' },
    },
    legal: {
      seoDescription: 'TAOMAN GROUP INVESTMENTS法律声明：发行人、托管人、知识产权、个人数据。',
      hero: { eyebrow: '法律声明', title: '法律信息', description: '与本网站的出版、托管和知识产权相关的所有信息。' },
    },
    privacy: {
      seoDescription: 'TAOMAN GROUP INVESTMENTS隐私政策：您的个人数据的收集、处理和保护。',
      hero: { eyebrow: '隐私', title: '隐私政策', description: '我们如何根据GDPR和当地标准收集、使用和保护您的个人数据。' },
    },
    terms: {
      seoDescription: 'TAOMAN GROUP INVESTMENTS网站使用条款。',
      hero: { eyebrow: '条款和条件', title: '使用条款', description: '管理我们网站和服务使用的规则。' },
    },
    home: {
      seoDescription:
        'TAOMAN GROUP INVESTMENTS——多哥与西非经共体地区的结构化投资、公私合作伙伴关系及运营服务（洗车、搬家、机修、运输）。',
      hero: {
        liveLabel: '直播',
        livePill: '实时监控',
        kpiLabel: '客户满意度',
        badgeMain: '战略合作伙伴 — TAOMAN GROUP INVESTMENTS',
        title: '卓越',
        subtitle: '体现在每项服务中',
