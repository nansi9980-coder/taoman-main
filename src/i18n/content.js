...
const CONTENT = {
  FR: {
    ...
    invest: {
      ...
      submit: { eyebrow: 'Soumettre un projet', title: 'Présenter votre porteur de projet à TAOMAN', cta: 'Soumettre mon projet' },
  ...
  EN: {
    ...
    invest: {
      ...
      submit: { eyebrow: 'Submit a project', title: 'Present your project sponsor to TAOMAN', cta: 'Submit my project' },
  ...
  ES: {
    ...
    invest: {
      ...
      submit: { eyebrow: 'Enviar un proyecto', title: 'Presente su portador de proyecto a TAOMAN', cta: 'Enviar mi proyecto' },
    ...
    home: {
      ...
      hero: {
        ...
        badgeMain: 'Socio estratégico — TAOMAN',
        title: 'Excelencia',
  ...
  PT: {
    ...
    invest: {
      ...
      submit: { eyebrow: 'Enviar um projeto', title: 'Apresente o portador do seu projeto à TAOMAN', cta: 'Enviar meu projeto' },
    ...
    home: {
      ...
      hero: {
        ...
        badgeMain: 'Parceiro estratégico — TAOMAN',
        title: 'Excelência',
  ...
  DE: {
    ...
    invest: {
      ...
      submit: { eyebrow: 'Projekt einreichen', title: 'Stellen Sie Ihren Projektträger TAOMAN vor', cta: 'Mein Projekt einreichen' },
    ...
    home: {
      ...
      hero: {
        ...
        badgeMain: 'Strategischer Partner — TAOMAN',
        title: 'Exzellenz',
  ...
  AR: {
    ...
    invest: {
      ...
      submit: { eyebrow: 'تقديم مشروع', title: 'قدّم حامل مشروعك إلى TAOMAN', cta: 'تقديم مشروعي' },
    ...
    home: {
      ...
      hero: {
        ...
        badgeMain: 'شريك استراتيجي — TAOMAN',
        title: 'التميز',
        subtitle: 'في كل خدمة',
  ...
  ZH: {
    ...
    invest: {
      ...
      submit: { eyebrow: '提交项目', title: '向 TAOMAN 介绍您的项目发起人', cta: '提交我的项目' },
