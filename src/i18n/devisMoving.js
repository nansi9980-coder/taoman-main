...
const DEVIS_MOVING = {
  ...
  EN: {
    intro: {
      ...
      paragraphs: [
        'Moving is one of the most stressful moments in the life of a household or a business. Poorly protected boxes, improvised crews, unsuitable trucks, vague quotes, delays: unpleasant surprises are common. TAOMAN Group Investment has structured its moving service to eliminate these risks.',
  ...
  ES: {
    intro: {
      ...
      paragraphs: [
        'La mudanza es uno de los momentos más estresantes en la vida de un hogar o de una empresa. Cajas mal protegidas, equipos improvisados, camiones inadecuados, presupuestos poco claros, retrasos: las malas sorpresas son frecuentes. TAOMAN Group Investment ha estructurado su servicio de mudanzas para eliminar estos riesgos.',
  ...
  DE: {
    intro: {
      ...
      paragraphs: [
        'Ein Umzug gehört zu den stressigsten Momenten im Leben eines Haushalts oder eines Unternehmens. Schlecht geschützte Kartons, improvisierte Teams, ungeeignete Lkw, unklare Angebote, Verzögerungen: böse Überraschungen sind häufig. TAOMAN Group Investment hat seinen Umzugsservice strukturiert, um diese Risiken zu beseitigen.',
  ...
  AR: {
    intro: {
      ...
      paragraphs: [
        'الانتقال من أكثر اللحظات إرهاقاً في حياة الأسرة أو المؤسسة. صناديق غير محمية، فرق عشوائية، شاحنات غير مناسبة، عروض غامضة، تأخيرات: المفاجآت السيئة شائعة. هيكلت TAOMAN Group Investment خدمة النقل لإزالة هذه المخاطر.',
  ...
  ZH: {
    intro: {
      ...
      paragraphs: [
        '搬迁是家庭或企业生活中压力最大的时刻之一。包装不当、临时拼凑的团队、不合适的卡车、模糊的报价、延误：意外时有发生。TAOMAN Group Investment 已将其搬迁服务结构化，以消除这些风险。',
